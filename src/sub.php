...
<body>
    ...
    <form>
        <h3><?php echo $translations['signup']; ?></h3>

        <label for="username"><?php echo $translations['username']; ?></label>
        <input type="text" placeholder="<?php echo $translations['username']; ?>" id="username">
        
        <label for="email"><?php echo $translations['email']; ?></label>
        <input type="text" placeholder="<?php echo $translations['email']; ?>" id="email">
        
        <label for="password"><?php echo $translations['password']; ?></label>
        <input type="password" placeholder="<?php echo $translations['password']; ?>" id="password">

        <button><?php echo $translations['login_form']; ?></button>
        <button class="login_with_42">
            <?php echo $translations['login_with']; ?>
